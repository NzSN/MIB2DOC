...
/* OBJECT-GROUP */
OBJ_GRP_DEFINED :
    IDENTIFIER OBJ_GRP_SPECIFIER OBJ_GRP;
OBJ_GRP :
...
/* NOTIFICATION-GROUP */
NOTIFY_GRP_DEFINED :
    IDENTIFIER NOTIFY_GRP_SPECIFIER NOTIFY_GRP;
NOTIFY_GRP :
...
/* MODULE_COMPILANCE */
COMPLIANCE_DEFINED :
    IDENTIFIER COMPLIANCE_SPECIFIER COMPLIANCE;
COMPLIANCE :
...
/* NOTIFICATION-TYPE */
NOTIFY_TYPE_DEFINED : 
    IDENTIFIER NOTIFY_TYPE_SPECIFIER NOTIFY_TYPE;
NOTIFY_TYPE : 
